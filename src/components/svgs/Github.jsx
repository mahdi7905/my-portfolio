...
const Github = () => {
  return (
    <svg className='socialLinks' width={'25px'} fill='white' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
        ...
        75.4-.3 83.6 0 6.5 4.6 14.4 17.3 12.1C428.2 457.8 496 362.9 
        496 252 496 113.3 383.5 8 244.8 8zM97.2 352.9c-1.3 1-1 3.3.7 
